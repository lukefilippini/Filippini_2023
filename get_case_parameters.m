...
if isequal(Case,'A')
    ...
    OB = struct('L1',100,'a1',1,'b1',0); % outer bound parameters (absorbing outer boundary)
elseif isequal(Case,'B')
    ...
    if d == 2
        ...
        OB = struct('L1',100,'a1',1,'b1',b1,'P1',P1); % outer bound parameters (semi-absorbing outer boundary with P1 = 0.5)
    else
...
elseif isequal(Case,'C')
    P = 1; % probability of movement
    IB = struct('L0',50,'a0',0,'b0',1); % inner bound parameters (reflecting inner boundary)
    OB = struct('L1',100,'a1',1,'b1',0); % outer bound parameters (absorbing outer boundary)
...
elseif isequal(Case,'E')
    P = 1; % probability of movement
    IB = struct('L0',50,'a0',1,'b0',0); % inner bound parameters (absorbing inner boundary)
    OB = struct('L1',100,'a1',1,'b1',0); % outer bound parameters (absorbing outer boundary)
elseif isequal(Case,'F')
    ...
    if d == 2
        ...
        IB = struct('L0',0,'a0',1,'b0',b0,'P0',P0); % outer bound parameters (semi-absorbing outer boundary with P1 = 0.5)
    else
...
elseif isequal(Case,'G')
    ...
    OB = struct('L2',100,'a1',1,'b1',0); % outer bound parameters (absorbing outer boundary)
